...
export const enum EventFlag {
  ...
  Splash = 4,
  /**
   * Атака промахнулась (Acc/(Acc+Eva) не прошёл), урона нет.
   *
   * Событие всё равно отправляется рендеру: игрок обязан видеть, что удар был
   * и не прошёл. Молчаливый промах читается как зависший юнит и ломает столп 2.
   */
  Miss = 8,
}
